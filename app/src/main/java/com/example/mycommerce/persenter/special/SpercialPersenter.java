package com.example.mycommerce.persenter.special;
...
public class SpercialPersenter  extends BasePersenter<ImodeSpecial.IView> implements ImodeSpecial.IPersenter{
    @Override
